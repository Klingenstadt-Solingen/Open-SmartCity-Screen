...
// / <div className="break-words text-left w-full bg-background-color h-full p-12">
// <div className="break-words text-center w-full text-7xl text-primary-color font-bold self-start">
//   Wetter <span>{props.weather?.shortName}</span>
// </div>
// <div className="break-words flex items-center justify-center w-full h-full">
//   <div className="break-words gap-8 container grid grid-cols-3 grid-rows-2 w-full">
//     <div
//       className="break-words p-6 box-border grid justify-center items-center w-full rounded-3xl bg-secondary-color col-span-2 gap-5"
//       style={{ gridTemplateColumns: '1fr 2fr' }}
...
//     <div
//       className="break-words p-5 text-left h-full grid overflow-hidden justify-center items-center w-full rounded-3xl bg-background-color-dark gap-5"
//       style={{ gridTemplateColumns: '1fr 2fr' }}
//     >
//       <div className="break-words flex items-center justify-center">
//         <UV fill={environment.primaryColor || '#004373'}></UV>
//       </div>
//       <div className="break-words text-2xl flex flex-col items-start gap-5 text-primary-color">
//         <span className="break-words border-primary-color font-bold">UV-Licht</span>
//         <div>
...
//     </div>
//     <div
//       className="break-words p-5 text-left h-full grid overflow-hidden justify-center items-center w-full rounded-3xl gap-5 bg-primary-color bg-opacity-70"
//       style={{ gridTemplateColumns: '1fr 2fr' }}
//     >
//       <div className="break-words flex items-center justify-center">
...
//     </div>
//     <div
//       className="break-words p-5 text-left h-full grid overflow-hidden justify-center items-center w-full rounded-3xl gap-5 bg-background-color-dark"
//       style={{ gridTemplateColumns: '1fr 2fr' }}
//     >
//       <div className="break-words flex items-center justify-center">
